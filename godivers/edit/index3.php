  ...
  <head>
    ...
    <script type="text/javascript">
      //<![CDATA[
        ...
        function edit(lng)
        {
  //        chkbox[0] = document.getElementById(
  ...
  <body>
    ...
    <div id="dvLanguages">
      <form method="post" action="index.php" id="frmElements" accept-charset="utf-8">
        ...
        <h4 class="lang">
          <input name="chkJa" type="checkbox" onclick="edit('ja')" />
					Edit Japanese 
					<input name="btnSubmit_ja" id="btnSubmit_ja" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
         <p class="textarea">
          <textarea rows="6" cols="80" lang="ja" name="txaWordsJA"><?php echo trim($Translations['ja']); ?></textarea>
        </p>
        <h4 class="lang">
				  <input name="chkEn" type="checkbox" onclick="edit('en')" />
          Edit English <input name="btnSubmit_en" id="btnSubmit_en" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
        <p class="textarea">
        ...
        <h4 class="lang">
          <input name="chkRu" type="checkbox" onclick="edit('ru')" />
					Edit Russian <input name="btnSubmit_ru"  id="btnSubmit_ru" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
        <p class="textarea">
