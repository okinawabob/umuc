...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <script type="text/javascript">
      //<![CDATA[
        var theLang = new Array('JA', 'EN', 'RU');
        function setCookie()
        {
  ...
  <body onload="javascript: getCookie(); javascript: checkDisplay()">
    ...
    <div id="dvLanguages">
      <form method="post" action="index.php" id="frmElements" accept-charset="utf-8">
        ...
        <h4 class="lang">
          <input name="chkRU" id="chkRU"  type="checkbox" onclick="setCookie()" />
					Edit Russian <input name="btnSubmit_ru"  id="btnSubmitRU" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
        <p class="textarea">
          <textarea rows="1" cols="80" lang="ru" id="txaWordsRU" name="txaWordsRU" readonly="readonly"><?php echo trim($Translations['ru']); ?></textarea>
        </p>
        <p>    
