      ...
      <form method="post" action="index.php" id="frmElements" accept-charset="utf-8">
        ...
        <h4 class="lang">
          <input name="chkJa" type="checkbox" onclick="edit('ja')" />
					Edit Japanese 
					<input name="btnSubmit_ja" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
         <p class="textarea">
        ...
        <h4 class="lang">
          ...
          Edit English <input name="btnSubmit_en" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
        <p class="textarea">
        ...
        <h4 class="lang">
          <input name="chkRu" type="checkbox" onclick="edit('ru')" />
					Edit Russian <input name="btnSubmit_ru" type="submit" value="Submit Modifications" disabled="disabled" />
        </h4>
        <p class="textarea">
